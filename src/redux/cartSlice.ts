...
export const cartSlice = createSlice({
  ...
  initialState,
  reducers: {
    contentReady: (state, action: PayloadAction<boolean>) => {
...
export const selectContentReady = (state: RootState) => state.cart.contentReady;
...
export const { contentReady, increment, decrement, deleteItem } = cartSlice.actions;
